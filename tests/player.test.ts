...
const mockSessionData = {
  ...
  firstTrack: {
    ...
    variants: [
      {
        id: 'v-1', url: 'https://cdn.test/track-1-hq.mp3', data: null, path: '/hq',
        ...
        fileName: 'track-one-hq.mp3', isPublic: true, contentType: 'audio/mpeg',
...
const mockTrackResult = {
  ...
  variants: [
    {
      id: 'v-2', url: 'https://cdn.test/track-2-hq.mp3', data: null, path: '/hq',
      size: 6000000, props: { codec: 'mp3', bitrate: 320, isStereo: true, isStripTags: false, isStripCover: false },
      variant: { id: 'var-hq', index: 'hq', variantType: { id: 'vt-1', title: 'HQ', viewerId: 'v1' } },
      fileName: 'track-two-hq.mp3', isPublic: true, contentType: 'audio/mpeg',
      isPreview: false, preview: { offsetStart: 0, offsetEnd: 0, duration: 0 },
    },
  ],
