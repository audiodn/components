...
const mockSessionData = {
  ...
  tracks: [{
    id: 'track-1', coverImagePrefix: '/img/', index: 'track-1', duration: 120,
    info: null, organizationIndex: null, order: 1, metadata: null,
    playerTitle: 'Integration Track', playerSubtitle: 'Test Artist',
    playerColor: '#c13c5b', fileName: 't.mp3', isDark: false, theme: [],
  }],
  firstTrack: {
    ok: true, playSessionId: 'sess-int', trackId: 'track-1',
    ...
    variants: [{
      id: 'v-1', url: 'https://cdn.test/t.mp3', data: null, path: '/hq',
      size: 5000000, props: { codec: 'mp3', bitrate: 320, isStereo: true, isStripTags: false, isStripCover: false },
      variant: { id: 'var-hq', index: 'hq', variantType: { id: 'vt-1', title: 'HQ', viewerId: 'v1' } },
      fileName: 't-hq.mp3', isPublic: true, contentType: 'audio/mpeg',
      isPreview: false, preview: { offsetStart: 0, offsetEnd: 0, duration: 0 },
    }],
    coverImage: {
...
vi.mock('../../src/lib/audio', () => ({
  createAudioInstance: vi.fn(() => ({
    ...
    paused: true, ended: false, readyState: 0, networkState: 0,
    error: null, src: '', currentSrc: '', autoplay: false,
  })),
}))
